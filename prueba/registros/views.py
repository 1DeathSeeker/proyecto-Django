...
def eliminarAlumno(request,id, confirmacion='registros/confirmarEliminacionA.html'):
...
def consultarAlumnoC(request,id):
...
def consultar7(request):
    alumnos=Alumnos.objects.filter(comentario__coment__contains="Dos")
    return render(request,"registros/consultas.html",{'alumnos':alumnos})
